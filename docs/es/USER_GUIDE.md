...
[English](../USER_GUIDE.md) | [Español](USER_GUIDE.md)
...
Para desplegar el servidor (Docker, TLS/Caddy, certificados) consultá [docs/SYNC-DEPLOYMENT.md](SYNC-DEPLOYMENT.md), [docs/SYNC_API.md](SYNC_API.md) y [docs/TLS-CERTIFICATES.md](TLS-CERTIFICATES.md).
